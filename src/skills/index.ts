...
export const builtInAgentSkills = {
  ...
  softwareVerification: defineSkill({
    ...
    tools: [standardToolNames.gitStatus, standardToolNames.gitDiff, standardToolNames.gitLog, standardToolNames.gitShow, standardToolNames.runCommand],
